...
if __name__ == "__main__":
    ...
    annotation_linegenerator = (line for line in annotation_file
    ...
    tRNA_linegenerator = (replace_nth_position_with(line, 2, 'exon', '\t')
    ...
    spikein_name_length_pairs_no_whitespace = ([
        token[0], len(''.join(token[1].split()))
    ] for token in spikein_pairs)
    # build a sequence of formatted spikein lines
    spikein_lines = (SPIKEIN_FORMAT.format(
